//
//  FlyoverCoverageViewController.swift
//  ListingLocation
//
...
class FlyoverCoverageViewController: BaseViewController {
    ...
    func setupWebView(){
        ...
        let url = URL (string: "http://www.mylistinglocation.com/flyover-coverage")
...
extension FlyoverCoverageViewController: UIWebViewDelegate{
