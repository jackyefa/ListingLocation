...
extension UIColor {
    ...
    func convertHexStringToColor (hexString: String) -> UIColor {
        ...
        let hexColorString = hexString.trimmingCharacters(in: .whitespacesAndNewlines).uppercased()
    ...
    class func eliteTextFieldTextColor() -> UIColor{
        return UIColor().convertHexStringToColor(hexString: "40403f")
    }
    
    class func textFieldBorderColor() -> UIColor{
        return UIColor().convertHexStringToColor(hexString: "8cb7d4")
    }
    
    
    class func eliteNavigationBarColor() -> UIColor{
        return UIColor().convertHexStringToColor(hexString: "30302f")
    }
    
    // MARK: - Custom methods using rgb code
    
    class func lightRedColor() -> UIColor{
        return UIColor(red: 173/255.0, green: 5/255.0, blue: 11/255.0, alpha: 0.6)
    }
